...
export const metadata: Metadata = {
  ...
  description: "A free PDF editor with native text editing, offline OCR, AI-ready Markdown, merge, split, compress, and convert tools. No watermarks or premium feature gates.",
