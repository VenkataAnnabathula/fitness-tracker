...
export default function Privacy(){return <LegalPage label="Our privacy promise" title="Your documents stay yours.">
  ...
  <h2>Local processing</h2><p>Opening, rendering, editing, merging, splitting, compressing, converting, and exporting happen on your computer. Working files are stored in the application’s local support directory and are not transmitted to The Caffeinate.</p>
